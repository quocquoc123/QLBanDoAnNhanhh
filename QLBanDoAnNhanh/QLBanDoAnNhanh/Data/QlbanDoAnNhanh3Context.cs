...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=laptop-eq0I61SI;Initial Catalog=QLBanDoAnNhanh3;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BinhLuan>(entity =>
        {
            entity.HasKey(e => e.MaBinhLuan).HasName("PK__BinhLuan__87CB66A058395EE0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChiTietD__3213E83FE87260AB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChiTietG__3213E83F7768339F");
        ...
        {
            entity.HasKey(e => e.MaDanhGia).HasName("PK__DanhGia__AA9515BF4110974B");
            ...
            entity.HasOne(d => d.MaNguoiDungNavigation).WithMany(p => p.DanhGia)
                .HasForeignKey(d => d.MaNguoiDung)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__DanhGia__MaNguoi__0A9D95DB");

            entity.HasOne(d => d.MaSanPhamNavigation).WithMany(p => p.DanhGia)
                .HasForeignKey(d => d.MaSanPham)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__DanhGia__MaSanPh__09A971A2");
        });

        modelBuilder.Entity<DanhMuc>(entity =>
        {
            entity.HasKey(e => e.MaDm).HasName("PK__DanhMuc__7A3EF4089AB5797B");
        ...
        {
            entity.HasKey(e => e.MaDh).HasName("PK__DonHang__7A3EF40F364235BB");
        ...
        {
            entity.HasKey(e => e.MaGiamGia).HasName("PK__GiamGia__EF9458E4EBFEDDE4");
        });

        modelBuilder.Entity<GioHang>(entity =>
        {
            entity.HasKey(e => e.MaGh).HasName("PK__GioHang__7A3E2D6BDF932C47");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HinhAnh__3213E83FB3CB8681");
        ...
        {
            entity.HasKey(e => e.MaKhuyenMai).HasName("PK__KhuyenMa__6F56B3BD31FB6601");
        ...
        {
            entity.HasKey(e => e.MaNguoiDung).HasName("PK__NguoiDun__446439EA68D8DCF4");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__PhanQuye__CD98460A6243B7DC");
        ...
        {
            entity.HasKey(e => e.MaSp).HasName("PK__SanPham__7A227A7AB77EBE7F");
        ...
        {
            entity.HasKey(e => e.MaThanhToan).HasName("PK__ThanhToa__D4B2584470EE58DB");
